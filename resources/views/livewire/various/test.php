...
class extends Component {
	...
	public function mount() {
		...
		$completeFakeSentence = $this->completeFixedOrRealSentence(); // Param: 0  ou rien pour avoir fake || Autre valeur pour avoir fixe
	...
	private function completeFixedOrRealSentence($fixedSentence = 0) {
		...
		return !$fixedSentence ? $this->faker->fakerSentence()->complete : "La belle-mère répondit n'avoir plus rien de la liquidation qui était close, et qu'il leur restait, outre Belleville, six cents livres de rente, Quoiqu'elle fût laide, sèche comme un cotret. et bougonnée. comme un printemps, certes madame Martin ne manquait pas de lui en procurer une autre plus commode. Le médecin, bien entendu, fit encore les frais de...";
	}
};
